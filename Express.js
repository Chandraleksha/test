...
// Connect to MongoDB
mongoose.connect('mongodb+srv://chandralekshabsc22:Leksha2704@cluster0.tc4tsng.mongodb.net/?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true })
  .then(() => {
